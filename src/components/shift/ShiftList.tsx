              ...
              }
              {
                addProduct ? (
                  <Button
                    ...
                    size="sm"
                  >
                    <i className='ri-add-line' /> Buat Data Shift
                  </Button>
                ) : ""
              }
            </div>
        ...
        <table className='table bordered-table mb-0'>
          <thead>
            <tr>
              ...
              ""}
              {showRow?.name ? ( <th scope='col'>Nama Shift</th>) : ""}
              {showRow?.action ? ( <th scope='col'>Jam Mulai Kerja</th>) : ""}
              {showRow?.action ? ( <th scope='col'>Jam Selesai Kerja</th>) : ""}
              {showRow?.action ? ( <th scope='col'>Jam  Istriahat</th>) : ""}
