...
import { DATA_COMMSSIONS } from "./DATA";
        ...
        renderHeader={
          <div className="d-flex flex-wrap gap-2 justify-content-between">
            ...
            <div className='d-flex flex-wrap align-items-center gap-3'>
              ...
              <Link href='commission/create' className='btn btn-sm btn-primary-600 gap-2 d-flex'>
                <i className='ri-add-line' /> Buat Komisi
              </Link>
            </div>
          </div>
        }
